 const { prh,prh1,cmd, getAdmin, tlang, prefix } = require('../lib')
            ...
            case 'antilink':
                {
                    ...
                    if (!checkgroup) {
                        await new prh({ id: citel.chat, antilink: "false" })
                            .save()
                        ...
                        await prh.updateOne({ id: citel.chat }, { antilink: "false" })
                       ...
                       case 'economy':
                {
                    let checkgroup = await prh.findOne({ id: citel.chat })
                    if (!checkgroup) {
                        await new prh({ id: citel.chat, economy: "false" })
                            .save()
                        ...
                        await prh.updateOne({ id: citel.chat }, { economy: "false" })
                ...
                case 'cardgame':
                    {
                        ...
                        if (!checkgroup) {
                            await new prh({ id: citel.chat, cardgame: "deactive" })
                                .save()
                            ...
                            await prh.updateOne({ id: citel.chat }, { cardgame: "deactive" })
                            return citel.reply("Successfully disabled *Card Game.*")
                        }
                    }
                    break
                case 'bot':
                    {
                        let checkgroup = await prh.findOne({ id: citel.chat })
                        if (!checkgroup) {
                            await new prh({ id: citel.chat, botenable: "false" })
                                .save()
                            ...
                            await prh.updateOne({ id: citel.chat }, { botenable: "false" })
                            return citel.reply(`Successfully disabled *${tlang().title}*`)
                        }
                    }
                    break
