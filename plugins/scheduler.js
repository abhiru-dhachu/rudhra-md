 const { tlang,prh,prefix,cmd } = require('../lib')
 cmd({
     pattern: "amute",
 ...
 async(Void, citel, text,{ isCreator }) => {
     ...
     //if(!Number.isInteger(text.split(':')[1])) return citel.reply(`Please provide correct form.\nEg: setmute ${prefix}22:00`)
           let Group = await prh.findOne({ id: citel.chat })
             if (!Group) {
                 await new prh({ id: citel.chat, mute: text }).save()
                 return citel.reply('Mute added.')
             } else {
                 await await prh.updateOne({ id: citel.chat }, { mute:text })
...
async(Void, citel, text,{ isCreator }) => {
   ...
   // if(!Number.isInteger(text.split(':')[1])) return citel.reply(`Please provide correct form.\nEg: setmute ${prefix}22:00`)
          let Group = await prh.findOne({ id: citel.chat })
            if (!Group) {
                await new prh({ id: citel.chat, unmute: text }).save()
                return citel.reply('Mute added.')
            } else {
                await await prh.updateOne({ id: citel.chat }, { unmute:text })
    ...
    if(!citel.isGroup) return citel.reply(tlang().group)
          let Group = await prh.findOne({ id: citel.chat })
            if (!Group) {
                ...
                await await prh.updateOne({ id: citel.chat }, { unmute:'false' })
    ...
    if(!citel.isGroup) return citel.reply(tlang().group)
          let Group = await prh.findOne({ id: citel.chat })
            if (!Group) {
                ...
                await await prh.updateOne({ id: citel.chat }, { mute:'false' })
